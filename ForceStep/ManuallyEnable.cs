...
namespace ForceStep
{
    ...
    internal sealed class ManuallyEnable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManuallyEnable"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in ManuallyEnable's constructor requires
            // the UI thread.
