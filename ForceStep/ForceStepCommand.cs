...
namespace ForceStep
{
    internal sealed class ForceStepCommand
    {
        ...
        private ForceStepCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            m_MenuItem = new OleMenuCommand(this.Execute, menuCommandID);
            ...
            m_MenuItem.BeforeQueryStatus += OnBeforeQueryStatus;
            m_MenuItem.CommandChanged += OnBeforeQueryStatus;

            m_Command = m_MenuItem;

            commandService.AddCommand(m_MenuItem);

        }

        private OleMenuCommand m_MenuItem;
